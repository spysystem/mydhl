...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://wsbexpress.dhl.com/rest/sndpt';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/1.1.0.1/PHP';
    ...
    {
        $report  = 'PHP SDK (MyDHL) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.1.0' . PHP_EOL;
        $report .= '    SDK Package Version: 1.1.0.1' . PHP_EOL;
