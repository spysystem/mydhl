...
class ExportLineItem implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['export_reason_type'] = isset($data['export_reason_type']) ? $data['export_reason_type'] : 'PERMANENT';
        $this->container['item_number'] = isset($data['item_number']) ? $data['item_number'] : null;
        $this->container['quantity'] = isset($data['quantity']) ? $data['quantity'] : null;
        $this->container['quantity_unit_of_measurement'] = isset($data['quantity_unit_of_measurement']) ? $data['quantity_unit_of_measurement'] : null;
        ...
        $this->container['manufacturing_country_code'] = isset($data['manufacturing_country_code']) ? $data['manufacturing_country_code'] : null;
    }
