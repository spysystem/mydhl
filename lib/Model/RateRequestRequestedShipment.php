...
class RateRequestRequestedShipment implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['get_detailed_rate_breakdown'] = isset($data['get_detailed_rate_breakdown']) ? $data['get_detailed_rate_breakdown'] : null;
        $this->container['include_additional_currencies'] = isset($data['include_additional_currencies']) ? $data['include_additional_currencies'] : null;
        $this->container['drop_off_type'] = isset($data['drop_off_type']) ? $data['drop_off_type'] : null;
        $this->container['next_business_day'] = isset($data['next_business_day']) ? $data['next_business_day'] : null;
        ...
        $this->container['declared_value_currecy_code'] = isset($data['declared_value_currecy_code']) ? $data['declared_value_currecy_code'] : null;
        $this->container['payment_info'] = isset($data['payment_info']) ? $data['payment_info'] : null;
        $this->container['account'] = isset($data['account']) ? $data['account'] : null;
        $this->container['payer_country_code'] = isset($data['payer_country_code']) ? $data['payer_country_code'] : null;
        $this->container['request_value_added_service'] = isset($data['request_value_added_service']) ? $data['request_value_added_service'] : null;
        $this->container['service_type'] = isset($data['service_type']) ? $data['service_type'] : null;
        $this->container['network_type_code'] = isset($data['network_type_code']) ? $data['network_type_code'] : null;
        $this->container['customer_aggrement_ind'] = isset($data['customer_aggrement_ind']) ? $data['customer_aggrement_ind'] : null;
        $this->container['validate_ready_time'] = isset($data['validate_ready_time']) ? $data['validate_ready_time'] : null;
