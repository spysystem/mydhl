...
class Billing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      *
      * @return BillingModelFields
      */
    public static function GetModelFields(): BillingModelFields
    {
        return new BillingModelFields();
    }

    /**
      * Return an object with the Model Attributes
      *
      * @return BillingModelAttributes
      */
    public static function GetModelAttributes(): BillingModelAttributes
    {
        return new BillingModelAttributes();
    }
    ...
    public const SHIPPING_PAYMENT_TYPE_S = 'S';
    public const SHIPPING_PAYMENT_TYPE_R = 'R';
    public const SHIPPING_PAYMENT_TYPE_T = 'T';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['shipping_payment_type']) && !in_array($this->container['shipping_payment_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'shipping_payment_type', must be one of '%s'",
                $this->container['shipping_payment_type'],
