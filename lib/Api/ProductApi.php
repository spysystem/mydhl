...
/**
     ...
     * @return \MyDHL\Model\SupermodelIoLogisticsExpressProducts|\MyDHL\Model\SupermodelIoLogisticsExpressErrorResponse|\MyDHL\Model\SupermodelIoLogisticsExpressErrorResponse
     */
     ...
     * @throws \MyDHL\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MyDHL\Model\SupermodelIoLogisticsExpressProducts|\MyDHL\Model\SupermodelIoLogisticsExpressErrorResponse|\MyDHL\Model\SupermodelIoLogisticsExpressErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function expApiProductsWithHttpInfo($account_number, $origin_country_code, $origin_city_name, $destination_country_code, $destination_city_name, $weight, $length, $width, $height, $planned_shipping_date, $is_customs_declarable, $unit_of_measurement, $origin_postal_code = null, $destination_postal_code = null, $next_business_day = null, $message_reference = null, $message_reference_date = null, $plugin_name = null, $plugin_version = null, $shipping_system_platform_name = null, $shipping_system_platform_version = null, $webstore_platform_name = null, $webstore_platform_version = null, $strict_validation = false, $get_all_value_added_services = false, $request_estimated_delivery_date = true, $estimated_delivery_date_type = 'QDDF', string $contentType = self::contentTypes['expApiProducts'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyDHL\Model\SupermodelIoLogisticsExpressProducts' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MyDHL\Model\SupermodelIoLogisticsExpressProducts' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MyDHL\Model\SupermodelIoLogisticsExpressProducts', []),
            ...
            $returnType = '\MyDHL\Model\SupermodelIoLogisticsExpressProducts';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MyDHL\Model\SupermodelIoLogisticsExpressProducts',
